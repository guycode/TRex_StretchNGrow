					...
					<ul class="nav-menu menu">
						<li class="menu-item has-dropdown">
							...
							<ul class="nav-dropdown menu">
								...
								<li class="menu-item"><a href="index.html" class="menu-link">Ver. 1</a> </li>
								<li class="menu-item"><a href="index_2.html" class="menu-link sub_active">Ver. 2</a> </li>
								<li class="menu-item"><a href="index_3.html" class="menu-link">Ver. 3</a> </li>
								<li class="menu-item"><a href="index_4.html" class="menu-link">Ver. 4</a> </li>
							</ul>
						</li>
						<li class="menu-item has-dropdown">
							<a role="button" class="menu-link">About</a>
							<ul class="nav-dropdown menu">
								<li class="menu-item"><a href="about.html" class="menu-link">Ver. 1</a> </li>
								<li class="menu-item"><a href="about_2.html" class="menu-link">Ver. 2</a> </li>
							</ul>
						</li>
						<li class="menu-item has-dropdown">
...
<!-- END | Header -->
	...
	<main id="main" class="page_content page_event_single">
				...
				<div class="row">
					<div class="col-md-3 col-lg-3">
						<div class="ft_col">
							...
							<div class="des_">
								<img src="images/des.png" alt="Image Des">
							</div>
							<ul class="info flw">
