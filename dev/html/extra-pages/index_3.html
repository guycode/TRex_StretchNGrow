...
<!-- BEGIN | Header -->
<header id="ht_header" class="v3_header flw">
	<!-- top -->
...
<!-- home counter -->
<div class="home_counter flw">
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-lg-3">
				<div class="item_cter">
					<h4 class="name_ct">Graduated</h4>
					<span class="space"></span>
					<b class="cter per">99</b>
					<img src="images/cter1.png" alt="image counter" class="img_cter">
				</div>
			</div>
			<div class="col-md-3 col-lg-3">
				<div class="item_cter">
					<h4 class="name_ct">Online courses</h4>
					<span class="space"></span>
					<b class="cter plus">1234</b>
					<img src="images/cter2.png" alt="image counter" class="img_cter spc">
				</div>
			</div>
			<div class="col-md-3 col-lg-3">
				<div class="item_cter">
					<h4 class="name_ct">Class rooms</h4>
					<span class="space"></span>
					<b class="cter plus">59</b>
					<img src="images/cter3.png" alt="image counter" class="img_cter">
				</div>
			</div>
			<div class="col-md-3 col-lg-3">
				<div class="item_cter">
					<h4 class="name_ct">Major</h4>
					<span class="space"></span>
					<b class="cter plus">159</b>
					<img src="images/cter4.png" alt="image counter" class="img_cter">
				</div>
			</div>
		</div>
	</div>
