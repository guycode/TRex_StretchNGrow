		...
		<div class="row">
			<div class="col-md-7 col-lg-7 col-md-offset-5 col-lg-offset-5">
				<div class="title_l flw">
					...
					<h4>• It’s easy and fast •</h4>
				</div>
				<form action="#" class="form_ flw">
					<label class="name_">
...
<!-- home pricing -->
<div class="home_pricing flw">
	<div class="container">
		<div class="row">
			<div class="title_ flw">
				<h3>Pricing table</h3>
				<h4>• Cheaper, good service, carefuly •</h4>
				<p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc <br>putamus parum claram, anteposuerit litterarum formas.</p>
			</div>
			<div class="pricing_table flw">
				<div class="col-md-4 col-lg-4">
					<div class="item_pr">
						...
						<div class="item_main">
							...
							<ul class="list_">
								...
								<li>Free <b>Foods</b></li>
								<li><b>-10%</b> Fee</li>
							</ul>
						</div>
						<a class="item_bot" href="#"><span class="ion-android-checkmark-circle"></span>APPLY NOW</a>
					</div>
				</div>
				<div class="col-md-4 col-lg-4">
					<div class="item_pr">
						...
						<div class="item_main">
							<span class="icon_bug icon_bug_2"></span>
							<dl class="dot_">
								<dt>
									<span></span>
									<span></span>
				...
				<div class="col-md-4 col-lg-4">
					<div class="item_pr">
						...
						<div class="item_main">
							<span class="icon_bug icon_bug_3"></span>
							<dl class="dot_">
								<dt>
									<span></span>
									<span></span>
...
<div class="home_event flw">
	<div class="container">
		...
		<a href="#" class="all_items">ALL items</a>
	</div>
</div>
<!-- end section event -->
<!-- section glery -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-6">
						<div class="title_l flw">
							<h3>Search class for our child</h3>
							<p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram.</p>
						</div>
						<form action="#" class="form_ flw">
							<label>
								<select>
									<option value="">What kind of programs do you want to apply for?</option>
									<option value="">Teacher</option>
									<option value="">Children</option>
								</select>
							</label>
							<label>
								<input type="text" placeholder="Your keywords..." required>
								<span></span>
							</label>
...
<!-- end section search class -->
<!-- home event gallery -->
<div class="home_event_gallery flw">
	<div class="container">
		<div class="row">
			<div class="title_ flw">
				<h3>Latest Events</h3>
				<h4>• Updaacte daily •</h4>
				<p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc <br>putamus parum claram, anteposuerit litterarum formas.</p>
			</div>
			<div class="box_eg flw">
				...
				<div class="item_eg">
					...
					<div class="item_sub">
						...
						<span class="date_">Start: December 29, 2015 - 8:00am</span>
						<div class="content">
							<p>Claritas est etiam processus dynamicus, qui  res sequitur mutationem consuetudiu lectorum Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas.</p>
							<a href="#" class="bt_link">Read more</a>
						</div>
					</div>
				</div>
				<div class="item_eg">
...
<!-- end home event gallery -->
<!-- home maps -->
<div class="home_maps flw">
	<div class="map">
		<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d7451.646382465613!2d105.80050039999999!3d20.9596144!3m2!1i1024!2i768!4f13.1!5e0!3m2!1svi!2s!4v1454406689833" frameborder="0" style="border:0" allowfullscreen></iframe>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-lg-4">
